...
import com.azspeedometer.Data;
import com.azspeedometer.GpsServices;
...
public class MainActivity extends AppCompatActivity implements LocationListener, GpsStatus.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_speed = (Speedometer) findViewById(R.id.tv_speed);
        ...
        //Interstitial Ads
        AdsLoader.loadIntAds(MainActivity.this, App.getInterstitialAdId());

        //Banner Ads
        AdsLoader.loadBannerAds(MainActivity.this, rlAds, App.getBannerId());
    }
    ...
    public void showGpsDisabledDialog() {
        ...
        alert.setTitle(getResources().getString(R.string.gps_disabled));
        alert.show();

...
import com.roomdb.adapter.NotesAdapter;
...
public class NoteListActivity extends AppCompatActivity implements NotesAdapter.OnNoteItemClick{
    ...
    private void displayList(){
        myRoomDatabase = MyRoomDatabase.getInstance(NoteListActivity.this);
    ...
    private static class RetrieveTask extends AsyncTask<Void,Void,List<Note>>{
        ...
        protected List<Note> doInBackground(Void... voids) {
            if (activityReference.get()!=null)
                return activityReference.get().myRoomDatabase.getNoteDao().getNotes();
            else
                return null;
        }
        ...
        new AlertDialog.Builder(NoteListActivity.this)
                ...
                .setItems(new String[]{"Delete", "Update"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                            case 0:
                                myRoomDatabase.getNoteDao().deleteNote(notes.get(pos));
                                notes.remove(pos);
                                listVisibility();
                                break;
                            case 1:
